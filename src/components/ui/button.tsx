  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        maroon: "bg-maroon text-paper-raised hover:bg-maroon-soft",
        outline:
          "border border-rule-strong bg-paper-raised text-ink hover:bg-paper hover:border-ink-soft",
        ghost: "text-ink-soft hover:bg-rule/40 hover:text-ink",
        destructive: "bg-debit text-paper-raised hover:bg-red-800",
